Vue.component('habit-card', {
    ...
    template: `
        <div class="masonry-item">
            <div class="card blue lighten-1 center white-text waves-effect waves-light" style="width: 100%">
                <div style="padding: 10px">
                    ...
                    <span v-if="!habit.ended" v-on:click="markComplete(habit)" class="right waves-effect waves-red" style="cursor: pointer; margin-right: 3px"><i class="material-icons">check_circle</i></span>
                </div>
